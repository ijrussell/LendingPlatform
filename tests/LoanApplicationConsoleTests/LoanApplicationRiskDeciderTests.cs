...
public class LoanApplicationRiskDeciderTests
{
    ...
    public void LoanAmount_OneMillionOrGreater_Approved(int loanAmount, short loanToValueRate, short creditScore)
    {
    ...
    public void LoanAmount_OneMillionOrGreater_Declined(int loanAmount, short loanToValueRate, short creditScore)
    {
    ...
    public void LoanAmount_LessThanOneMillion_Approved(int loanAmount, short loanToValueRate, short creditScore)
    {
        var status = RunRiskDecider(loanAmount, loanToValueRate, creditScore);
    ...
    public void LoanAmount_LessThanOneMillion_Declined(int loanAmount, short loanToValueRate, short creditScore)
    {
        var status = RunRiskDecider(loanAmount, loanToValueRate, creditScore);
    ...
    private static LoanApplicationStatus RunRiskDecider(int loanAmount, short loanToValueRate, short creditScore)
    {
